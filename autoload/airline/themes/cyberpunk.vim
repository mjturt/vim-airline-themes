...
let s:N1 = [ '#bcbcbc' , '#d300c4' , 17 , 129  ]
let s:N2 = [ '#d75fd7' , '#4e4e4e' , 201 , 18 ]
let s:N3 = [ '#c6c6c6' , '#3a3a3a' , 46 , 17 ]

" Insert mode
let s:I1 = [ '#CACFD2' , '#009966' , 17 , 46  ]
let s:I2 = [ '#d75fd7' , '#4e4e4e' , 201 , 18 ]
let s:I3 = [ '#c6c6c6' , '#3a3a3a' , 46 , 17 ]
